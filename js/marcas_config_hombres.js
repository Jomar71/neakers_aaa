// ==========================================
// CONFIGURACIÓN DE MARCAS PARA HOMBRES
// ==========================================
// Utiliza este archivo para configurar los banners (imágenes principales)
// y descripciones de cada marca que aparecerán en la sección de hombres.
// IMPORTANTE: Asegúrate de mantener el formato exacto.

const marcasConfigHombres = {
    "ADIDAS": {
    ...
    "DIESEL": {
        "banner": "img/logos/logos_hombres/LOGODIESEL.jpeg",
    ...
    "NIKE": {
        "banner": "img/logos/logos_hombres/LOGONIKE.jpeg",
        "descripcion": "Just Do It. Innovación y rendimiento en cada par."
    },
    "ON CLOUD": {
        "banner": "img/logos/logos_hombres/LOGOONCLOUD.jpeg",
    ...
    "TIMBERLAND": {
        "banner": "img/logos/logos_hombres/LOGOTIMBERLAND.jpeg",
    ...
    "UNDER ARMOUR": {
        "banner": "img/logos/logos_hombres/LOGOUNDERARMOUR.jpeg",
        "descripcion": "Rendimiento técnico y durabilidad."
    },
    "VANS": {
        "banner": "img/logos/logos_hombres/LOGOVANS.jpeg",
